...
export default function OwnerProjectOverviewPage() {
  return (
    <div>
      {/* Project hero */}
      <Card className="mb-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">1000 Innovation Way, Palo Alto, CA 94301</p>
          </div>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        ...
        <Card>
          <p className="text-xs uppercase tracking-wider text-gray-500 mb-1">CHANGE ORDERS</p>
          <p className="text-2xl font-bold text-gray-400">--</p>
