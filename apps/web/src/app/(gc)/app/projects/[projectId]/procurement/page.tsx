      ...
      {hasData && (
        <div className="grid grid-cols-3 gap-4 mb-5">
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <div className="text-2xl font-bold text-gray-900 mt-1">{MOCK_PROCUREMENT.length}</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="text-xs text-gray-500 uppercase tracking-wide">At Risk</div>
            <div className="text-2xl font-bold text-red-600 mt-1">{atRiskCount}</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="text-xs text-gray-500 uppercase tracking-wide">Total Est. Value</div>
